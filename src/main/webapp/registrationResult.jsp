...
<c:forEach items="${noticias}" var="noticia">
	<tr>
		...
		<td><c:out value="${noticia.descripcion}"/></td>
                <td><a href="<%= request.getContextPath() + "/PublicacionForm.jsp?idNoticia=1"%>">Add publicacion</a></td>
	</tr>
</c:forEach>
<button onclick="getAllNoticias()">Refresh</button>
</tbody>
</table>	
